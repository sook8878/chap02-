...
public class Application1 {
	...
	public static void main(String[] args) {
		...
		// 비교연산자
		// 비교연산자는 피연산자 사이에서 상대적인 크기를 판단하여 참(true) 혹은 거짓(false)를 반환하는 연산자이다.
		// 연산자 중 참 혹은 거짓을 반환하는 연산자는 삼항연산자의 조건식이나 조건문의 조건절에 사용된다.
		
		// 비교 연산자의 종류
		// '==' : 왼쪽의 피연산자와 오른쪽의 피연산자가 같으면 true 다르면 false반환
		// '!=' : 왼쪽의 피연산자와 오른쪽의 피연산자가 다르면 true 같은면 false를 반환
		// '>'  : 왼쪽의 피연산자가 오른쪽의 피연산자보다 크면 true 아니면 false를 반환
		// '>=' : 왼쪽의 피연산자가 오른쪽의 피연산자보다 크거나 같으면 true 아니면 false반환
		...
		System.out.println("bool1이 bool2가 같은지 비교 : " + (bool1 == bool2));
		System.out.println("bool1이 bool2가 같지 않은지 비교 : " + (bool1 != bool2));
